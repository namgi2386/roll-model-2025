...
- [메인 페이지](#메인-페이지)
- [워크스페이스](#워크스페이스)
    - [DATA 전처리 기능](#data-전처리-기능)
    - [DATA 전처리 완료 및 결과](#data-전처리-완료-및-결과)
    - [ML 모델 파라미터 설정](#ml-모델-파라미터-설정)
    - [학습 시작 후](#학습-시작-후)
- [사용자 대시보드 페이지](#사용자-대시보드-페이지)
    - [오픈소스 모델 공유 페이지](#오픈소스-모델-공유-페이지)
- [모델 상세 페이지](#모델-상세-페이지)
    - [전처리 데이터 상세](#전처리-데이터-상세)
    - [ML 모델 상세](#ml-모델-상세)
    - [재학습 버전관리 상세](#재학습-버전관리-상세)
    - [API 서빙 상세](#api-서빙-상세)
  - [👥 팀 구성](#-팀-구성)
    - [👥 팀원 소개](#-팀원-소개)
      - [임남기 (FE, 팀장)](#임남기-fe-팀장)
      - [박가희 (FE)](#박가희-fe)
      - [김준석 (BE, Infra)](#김준석-be-infra)
      - [정규현 (BE, Infra)](#정규현-be-infra)
      - [권남희 (BE, 발표)](#권남희-be-발표)
      - [진우석 (BE)](#진우석-be)
